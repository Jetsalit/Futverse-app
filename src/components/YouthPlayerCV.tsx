...
export default function YouthPlayerCV({ player, onBack }: YouthPlayerCVProps) {
  const [activeTab, setActiveTab] = useState<"overview" | "development">(
    "overview",
  );
          ...
          <div className="mt-10 pt-8 border-t border-slate-800 grid grid-cols-2 gap-4 gap-y-6">
            <div>
              ...
              <div className="text-lg font-bold text-slate-200">
                {player.age || 15}{" "}
                <span className="text-xs text-slate-500 font-normal">yo</span>
              </div>
            </div>
            <div>
              <div className="text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-1">
              ...
              <div className="space-y-6 flex flex-col">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-end gap-3 mb-2">
                      <span className="text-5xl font-black text-slate-800 tracking-tight">
                        85<span className="text-3xl text-slate-400">%</span>
                      </span>
                    </div>
                    <p className="text-sm text-slate-500 font-medium mb-5">
                      Target goals successfully completed this season.
                    </p>
                ...
                <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-2xl p-6 shadow-md text-white relative overflow-hidden flex-1">
                  ...
                  <p className="text-sm md:text-base leading-relaxed font-medium text-indigo-50 italic relative z-10">
                    "Displays excellent technical groundwork and spatial
                    awareness. The current priority is to build core strength
                    and explosive speed. A natural leader in the center of the
                    pitch with high tactical maturity for his age."
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="p-4 rounded-xl border border-slate-100 bg-slate-50">
                  ...
                  <div className="flex items-end justify-between mb-3">
                    ...
                    <div className="text-xs font-bold text-emerald-600 bg-emerald-100 px-2 py-0.5 rounded-md">
                      +2.1 from last test
                    </div>
                  </div>
                ...
                <div className="p-4 rounded-xl border border-slate-100 bg-slate-50">
                  ...
                  <div className="flex items-end justify-between mb-3">
                    ...
                    <div className="text-xs font-bold text-slate-500 bg-slate-200 px-2 py-0.5 rounded-md">
                      Stable
                    </div>
                  </div>
                  <div className="w-full h-1.5 bg-slate-200 rounded-full overflow-hidden">
