    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={pillar.title}
            className={`${pillar.bg} rounded-xl p-4 border border-white/50 shadow-sm`}
          >
            <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">
              {pillar.title}
            </div>
            <div className={`text-2xl font-black ${pillar.color}`}>
              {pillar.score}
            </div>
          </div>
        ))}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-widest flex items-center gap-2">
                <Target size={16} className="text-indigo-500" /> Development
                Goals
              </h3>
            </div>
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2 text-sm text-slate-700">
                    ...
                    Improve weak foot (left foot) finishing consistency inside
                    the penalty box.
                  </li>
                  <li className="flex items-start gap-2 text-sm text-slate-700">
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2">
                  <Award size={14} className="text-amber-500" /> Long-term
                  (Season)
                </h4>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2 text-sm text-slate-700">
                    <div className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-1.5 shrink-0" />
                    Establish status as a starting XI player by improving
                    tactical awareness in high press.
                  </li>
                  <li className="flex items-start gap-2 text-sm text-slate-700">
                    <div className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-1.5 shrink-0" />
                    Achieve 15+ goals/assists combined contribution for the
                    season.
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-4 border-b border-slate-200 bg-slate-50">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-widest flex items-center gap-2">
                <FileText size={16} className="text-indigo-500" /> Strengths &
            ...
            <div className="divide-y divide-slate-100">
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Excellent 1v1 dribbling, tight ball control, and strong
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Weak foot crossing accuracy, aerial heading technique.
                  </p>
                </div>
              </div>
              {/* Tactical */}
              <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Off-the-ball movement in the final third, attacking
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Defensive positioning during high press, tracking back
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Top acceleration, high agility, strong core balance.
                  </p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-bold text-amber-600 uppercase">
                  ...
                  <p className="text-sm text-slate-600">
                    Upper body strength for hold-up play, stamina for 90-min
                    high intensity.
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600">
                    High confidence in 1v1 situations, aggressive attacking
                    mindset.
                  </p>
                </div>
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Body language after losing the ball, emotional control under
                    pressure.
                  </p>
                </div>
              </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
              ...
              <button
                onClick={() => setIsAssignDrillModalOpen(true)}
              ...
              <div className="border border-slate-200 rounded-xl p-4 flex flex-col gap-4 group">
                <div className="flex justify-between items-start">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-800 text-sm">
                        Left-foot Finishing Drill
                      </h4>
                      <p className="text-xs text-slate-500 mt-1 max-w-lg">
                        Practice finishing from various angles using the weaker
                        foot. Complete 50 reps after every team training
                        session.
                      </p>
                  ...
                  <select
                    ...
                    className="text-xs font-bold px-3 py-1.5 rounded-lg border-2 border-emerald-500 text-emerald-700 bg-emerald-50 outline-none"
                  >
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
                  ...
                  <p className="text-sm text-slate-700">
                    Great progress so far. Power is improving, now focus on
                    placing the ball into the corners rather than just hitting
                    it hard.
                  </p>
                </div>
              </div>
              ...
              <div className="border border-slate-200 rounded-xl p-4 flex flex-col gap-4 group">
                <div className="flex justify-between items-start">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-800 text-sm">
                        Defensive Positioning Video Analysis
                      </h4>
                      <p className="text-xs text-slate-500 mt-1 max-w-lg">
                        Watch the assigned pressing clips from last match.
                        Identify moments where you lost track of the fullback.
                      </p>
                      <div className="flex items-center gap-2 mt-2">
                        <span className="text-[10px] font-bold uppercase px-2 py-0.5 rounded-full bg-slate-100 text-slate-600">
                          Tactical
                        ...
                        <button
                          ...
                          className="text-xs text-indigo-600 font-medium hover:underline flex items-center gap-1 bg-transparent border-none p-0 cursor-pointer"
                        >
                          Link to Video Clips
                        </button>
                      </div>
                  ...
                  <select
                    ...
                    className="text-xs font-bold px-3 py-1.5 rounded-lg border-2 border-amber-500 text-amber-700 bg-amber-50 outline-none"
                  >
                    <option value="todo">To Do</option>
                    <option value="inprogress">In Progress</option>
                    <option value="achieved">Achieved</option>
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
                  ...
                  <div className="flex justify-end mt-2">
                    <button className="text-[11px] font-bold bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1.5 rounded">
                      Save Note
                    </button>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
            <div className="p-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
              <h3 className="font-bold text-slate-800">
                Assign Training Drill
              </h3>
              <button
                onClick={() => setIsAssignDrillModalOpen(false)}
            ...
            <div className="p-4">
              <p className="text-xs text-slate-500 mb-4">
                Select a drill from the Drill Library to add to this player's
                action plan.
              </p>
            ...
            <div className="p-4 border-t border-slate-200 flex justify-end gap-2 bg-slate-50">
              ...
              <button
                onClick={() => {
                  ...
                  alert("Drill specific ID linked and saved to action plan.");
                }}
