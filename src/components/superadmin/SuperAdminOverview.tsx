    ...
    <div className="space-y-6">
      <section aria-labelledby="platform-overview-title">
        ...
        <div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-7">
          ...
          <SuperAdminKpiCard label="Coaches" value={roleCounts.coaches} detail="Effective user roles" icon={GraduationCap} tone="blue" />
          <SuperAdminKpiCard label="Player Accounts" value={roleCounts.playerAccounts} detail="Registered accounts, not full registry" icon={ScanFace} tone="indigo" />
          <SuperAdminKpiCard label="Parents" value={roleCounts.parents} detail="Effective user roles" icon={UsersRound} tone="violet" />
          <SuperAdminKpiCard label="Scouts" value={roleCounts.scouts} detail="Effective user roles" icon={SearchCheck} tone="amber" />
