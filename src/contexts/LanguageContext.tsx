...
export const translations: Translations = {
  ...
  dash_quick_op_desc: { en: "Core management modules", th: "ระบบจัดการหลักของแพลตฟอร์ม" },
  ...
  dashboard_desc: { en: "Overview of your club operations and management modules", th: "ภาพรวมการดำเนินงานและระบบจัดการสโมสร" },
  dashboard_section_daily: { en: "Daily Operations", th: "ปฏิบัติการรายวัน" },
  dashboard_item_period_title: { en: "Weekly Periodization", th: "ตารางซ้อมรายสัปดาห์" },
  dashboard_item_period_desc: { en: "Training plans (Microcycle)", th: "แผนการฝึกซ้อม (Microcycle)" },
  dashboard_item_youth_title: { en: "Youth Academy Roster", th: "รายชื่อนักเตะเยาวชน" },
  dashboard_item_youth_desc: { en: "Manage youth players", th: "จัดการนักเตะเยาวชน" },
  dashboard_item_xi_title: { en: "Starting XI & Tactics", th: "จัดตัวผู้เล่นและแทคติก" },
  dashboard_item_xi_desc: { en: "Match tactics & lineup builder", th: "จำลอง 11 ตัวจริงก่อนแข่ง" },
  
  dashboard_section_academy: { en: "Academy Management", th: "การจัดการอคาเดมี" },
  dashboard_item_pro_title: { en: "Professional Players", th: "นักเตะอาชีพ" },
  dashboard_item_pro_desc: { en: "Elite squad management", th: "จัดการทีมชุดใหญ่" },
  dashboard_item_coaches_title: { en: "Coaching Staff", th: "ทีมงานผู้ฝึกสอน" },
  dashboard_item_coaches_desc: { en: "Coach profiles & assignments", th: "โปรไฟล์และงานของโค้ช" },
  dashboard_item_recovery_title: { en: "Recovery & Medical", th: "ฟื้นฟูและพยาบาล" },
  dashboard_item_recovery_desc: { en: "Player health & fitness", th: "สุขภาพและความฟิต" },

  dashboard_section_resources: { en: "Resources & Recruitment", th: "ทรัพยากรและการสรรหา" },
  dashboard_item_drills_title: { en: "Drill Library", th: "คลังแบบฝึกซ้อม" },
  dashboard_item_drills_desc: { en: "Training exercises repository", th: "รวบรวมแบบฝึกซ้อม" },
  dashboard_item_scout_title: { en: "Scouting Portal", th: "ระบบแมวมอง" },
  dashboard_item_scout_desc: { en: "Talent identification", th: "ค้นหานักเตะดาวรุ่ง" },
};
