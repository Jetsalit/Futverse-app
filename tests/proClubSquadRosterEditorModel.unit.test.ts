...
test("blank primary position discards stale additional positions before validation", () => {
  const draft = {
    ...createProClubSquadRosterEditorDraft("provisional-stale-additional"),
    firstName: "Real",
    lastName: "Player",
    position: "",
    additionalPositions: ["LB", "RB", ""],
    jerseyNumber: "3",
  };
