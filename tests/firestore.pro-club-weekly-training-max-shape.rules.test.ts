...
import { doc, serverTimestamp, setDoc, writeBatch, type DocumentData, type Firestore } from "firebase/firestore";

const PROJECT_ID = "demo-futverse-pr119-max-shape-r2";
...
function planData(): DocumentData {
  return {
    ...
    createdAt: serverTimestamp(), createdBy: HEAD_COACH_UID,
    updatedAt: serverTimestamp(), updatedBy: HEAD_COACH_UID,
  };
}
