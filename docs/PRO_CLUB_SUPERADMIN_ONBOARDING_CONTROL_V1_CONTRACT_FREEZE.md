...
Rejection must remain atomic and must revoke the invitation without creating Membership or Staff authority.
...
23. existing OWNER/ADMIN onboarding continues to pass;
24. existing claimant onboarding continues to pass;
25. Academy regression remains green;
26. production default-deny remains intact.
