$lines = Get-Content -Path "src/components/YouthPlayerCV.tsx"
...
$output | Set-Content -Path "src/components/YouthPlayerCV.tsx" -Encoding UTF8
Write-Host "YouthPlayerCV.tsx updated successfully."
