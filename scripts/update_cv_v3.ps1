...
$newPath = "c:\Users\asus\Documents\Futverse-app\src\components\YouthPlayerCV_new.tsx"
...
$output | Set-Content -Path $newPath -Encoding UTF8
Move-Item -Path $newPath -Destination $path -Force
Write-Host "SUCCESS: YouthPlayerCV.tsx updated successfully using new file replacement!"
